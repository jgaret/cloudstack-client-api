...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Creates an account")
 
    parser.add_argument("accounttype",help="Type of the account.  Specify 0 for user, 1 for root admin, and 2 for domain admin")
    ...
    parser.add_argument("--account",dest="account",help="Creates the user under the specified account. If no account is specified, the username will be used as the account name.")
    parser.add_argument("--domainid",dest="domainid",help="Creates the user under the specified domain.")
